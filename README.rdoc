Message Board React_On_Rails App
================================

Overview
--------

1. The react code lives under /client/
2. Uses the react_on_rails gem for react and webpack integration.
3. Hosted on Heroku https://messageboard-bk.herokuapp.com/
4. Has markdown capability for posts
5. Uses friendly_id for prettier urls
6. Uses the heroku/ruby and nodejs buildpack for deployment.
...
7. When commenting on a post, you have freedom as far as the layout goes, you can just have a little box that opens, and the user types in their comment. You can also use a modal, etc, whatever you want. It makes more sense to have the form for adding a
